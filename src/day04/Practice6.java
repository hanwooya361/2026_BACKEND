...
public class Practice6 {
    public static void main(String[] args) {
        ...
        int max = numbers2[0];  // 첫번째 값을 max 정하고, 만약 max보다 1번째 요소값이 더 크면 max에 대입
