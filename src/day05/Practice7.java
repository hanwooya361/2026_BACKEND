...
public class Practice7 {
    public static void main(String[] args) {
        ...
        pd2.name = "콜라";
        pd2.price = 2000;
        if(pd1.price > pd2.price){ System.out.println(pd1.name);}
        else{System.out.println(pd2.name);}  
        ...
        py2.power = 85;
        py2.speed = 92;
        if(py1.power+py1.speed > py2.power+py2.speed){System.out.println(py1.name);}
        else{System.out.println(py2.name);}

        // 9.
        new Menultem();
        Menultem me1 = new Menultem();
        Menultem me2 = new Menultem();
        Menultem me3 = new Menultem();
        me1.name = "김치찌개";
        me1.price = 8000;
        me1.isSignature = true;
        me2.name = "된장찌개";
        me2.price = 8000;
        me2.isSignature = false;
        me3.name = "계란찜";
        me3.price = 3000;
        me3.isSignature = false;
        if (me1.isSignature) {
            System.out.printf("[대표메뉴] %s : %d원\n", me1.name, me1.price);
        } else if (me2.isSignature) {
            System.out.printf("[대표메뉴] %s : %d원\n", me2.name, me2.price);
        } else if (me3.isSignature) {
            System.out.printf("[대표메뉴] %s : %d원\n", me3.name, me3.price);
        }
